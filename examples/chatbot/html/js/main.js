...
function initWebSocket() {
  ...
  websocket_audio.onmessage = function (e) {
    ...
    let audioBuffer = audioContext_tts.createBuffer(
      1,
      float32Array.length,
      24000
    );
    ...
    new_whisper_speech_audio_element(
      "audio-" + available_audio_elements,
  ...
  websocket.onmessage = function (e) {
    ...
    if ("message" in data) {
      ...
      new_text_element(
        "<p>" + data["llm_output"][0] + "</p>",
        "llm-" + available_transcription_elements
      );
    }
...
function new_transcription_time_element(time) {
  ...
  text_element.innerHTML =
    "<span>WhisperLive - Transcription time: " + time + "ms</span>";
...
function new_llm_time_element(time) {
  ...
  first_response_text_element.innerHTML =
    "<span>Phi-2 first response time: " + time + "ms</span>";

  var complete_response_text_element = document.createElement("div");
  complete_response_text_element.innerHTML =
    "<span>Phi-2 complete response time: " + time + "ms</span>";
...
function new_whisper_speech_time_element(time) {
  ...
  var text_element = document.createElement("div");
  text_element.innerHTML =
    "<span>WhisperSpeech response time: " + time + "ms</span>";
